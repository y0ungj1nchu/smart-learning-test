...
// --- 2. (추가) 로그인 상태를 확인하고 리다이렉트하는 헬퍼 컴포넌트 ---
const RootRedirect = () => {
  // 백엔드 API에서 발급받은 'authToken'이 있는지 확인합니다.
  const isLoggedIn = !!localStorage.getItem("authToken");
  
  // authToken이 있으면 /home/after로, 없으면 /home/before로 보냅니다.
  return isLoggedIn ? <Navigate to="/home/after" replace /> : <Navigate to="/home/before" replace />;
};
// ----------------------------------------------------------------
